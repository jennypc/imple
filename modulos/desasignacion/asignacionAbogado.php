...
if (isset($_POST['update'])) {
    $idAsp=$_POST['idasp'];
    $storedQuery = "execute [dbo].[sp_ActualAsignacionAbogado]'$idAsp'";
    ...
    if($stored['Respuesta']==1){
        ...
        echo '<meta http-equiv="refresh" content="0,url=inicio2.php?rol='.$_GET['rol'].'&plz='.$_GET['plz'].'&name='.$_GET['name'].'">';
    }
}
?>
